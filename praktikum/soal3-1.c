...
//Dalam kode yang sudah diperbaiki ini, subMenu dideklarasikan dengan benar sebagai variabel integer di dalam fungsi main. Label Menu sekarang menggunakan subMenu dengan benar.
